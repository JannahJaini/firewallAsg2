...
sub ip_header
{
	...
	my $ip_frag_id = 0;
	my $ip_frag_flag = '000';
	my $ip_frag_offset = '000000000000';
	my $ip_ttl = 255;
	my $ip_proto = 17;
	my $ip_checksum = 0;

	my $ip_header = pack(
		'H2 H2 n n B16 h2 c n a4 a4', $ip_ver . $ip_header_len, $ip_tos,$ip_total_len, $ip_frag_id, $ip_frag_flag, $ip_frag_offset, $ip_ttl, $ip_proto, $ip_checksum, $ip_src, $ip_dst);
	return $ip_header;
}
